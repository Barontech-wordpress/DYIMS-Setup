                               ...
                               <?php echo form_open(site_url('accounting/feetype/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12 gsms-nice-select_" name="head_type" id="fee_type" onchange="show_class_amount(this.value, false);">
                                ...
                                <div class="item form-group fn_instruction display">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="instructions" style="padding: 5px; margin:20px 0px 20px 0px;"><strong><?php echo $this->lang->line('instruction'); ?>: </strong> 
                                            <ol>
                                                <li><?php echo $this->lang->line('fee_type_instruction_sale_1'); ?></li>
                                ...
                                <div class="item form-group fn_amount_head display">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for=""><?php echo $this->lang->line('class'); ?>  <i class="fa fa-long-arrow-down blue"></i></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12" style="padding-top: 6px;">                                       
                                        <strong>: <?php echo $this->lang->line('amount'); ?> <i class="fa fa-long-arrow-down blue"></i></strong>
                                    </div>
                                </div> 
                            ...
                            <div class="x_content"> 
                               <?php echo form_open(site_url('accounting/feetype/edit/'.$feetype->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12 gsms-nice-select_" name="head_type_v" id="fee_type_v" onchange="show_class_amount(this.value, true);" disabled="disabled">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                                                                    
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="title"  id="title" value="<?php echo isset($feetype->title) ?  $feetype->title : ''; ?>" placeholder="<?php echo $this->lang->line('title'); ?>" required="required" type="text">
                                        <div class="help-block"><?php echo form_error('title'); ?></div>
                                    </div>
                                </div>

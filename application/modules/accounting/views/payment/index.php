                    ...
                    <div class="tab-content"> 
                        ...
                        <div class="x_content"> 
                           <?php echo form_open(site_url('accounting/payment/paid/'.$invoice_id), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="payment_method"><?php echo $this->lang->line('payment_method'); ?> <span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="display fn_dbbl"  style="<?php if(isset($post) && $post['payment_method'] == 'dbbl'){ echo 'display:block;';} ?>">
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="dbbl_card_type"><?php echo $this->lang->line('dbbl_card_type'); ?> <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">                                        
                                        <div class="row">
                                            <div class="col-md-2 col-sm-2 col-xs-6">
                                                <input type="radio" name="dbbl_card_type" required="required" class="dbbl_card_type" value="1">                                                
                                                <img src="<?php echo IMG_URL; ?>dbbl/dbbl-nexus.png" alt="Visa" />
                                            </div>
                                            <div class="col-md-2 col-sm-2 col-xs-6">
                                                <input type="radio" name="dbbl_card_type" required="required" class="dbbl_card_type" value="2">                                                
                                                <img src="<?php echo IMG_URL; ?>dbbl/dbbl-master.png" alt="Visa" />
                                            </div>
                                            <div class="col-md-2 col-sm-2 col-xs-6">
                                                <input type="radio" name="dbbl_card_type" required="required" class="dbbl_card_type" value="3">                                                
                                                <img src="<?php echo IMG_URL; ?>dbbl/dbbl-visa.png" alt="Visa" />
                                            </div>
                                            <div class="col-md-2 col-sm-2 col-xs-6">
                                                <input type="radio" name="dbbl_card_type" required="required" class="dbbl_card_type" value="4">                                                
                                                <img src="<?php echo IMG_URL; ?>dbbl/visa.png" alt="Visa" />
                                            </div>
                                            <div class="col-md-2 col-sm-2 col-xs-6">
                                                <input type="radio" name="dbbl_card_type" required="required" class="dbbl_card_type" value="5">                                                
                                                <img src="<?php echo IMG_URL; ?>dbbl/master.png" alt="Visa" />
                                            </div>
                                            <div class="col-md-2 col-sm-2 col-xs-6">
                                                <input type="radio" name="dbbl_card_type" required="required" class="dbbl_card_type" value="6">                                                
                                                <img src="<?php echo IMG_URL; ?>dbbl/rocket.png" alt="Visa" />
                                            </div>
                                        </div>										

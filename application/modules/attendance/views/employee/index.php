    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
           ...
           <?php  if (isset($employees) && !empty($employees)) { ?> 
            <div class="x_content">             
                <div class="row">
                    <div class="col-md-4  col-md-offset-4 layout-box">
                        <p>
                        ...
                        <div class="row">
                            <?php if(isset($at_employees_image)){
                                $at_image=$at_employees_image->photo;
                            }else{
...
<link href="<?php echo VENDOR_URL; ?>datepicker/datepicker.css" rel="stylesheet">
 ...
 <script type="text/javascript">
  ...
  $('#imageUpload').on('submit',function(e){
      ...
      $.ajax({
          type   : "POST",
          url    : "<?php echo site_url('attendance/employee/picUpload'); ?>",
          data   : formdata,
          async  : false,
          processData: false,
          contentType: false,

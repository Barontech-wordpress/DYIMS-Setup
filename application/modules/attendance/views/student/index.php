            ...
            <div class="x_content">             
                <div class="row">
                    <div class="col-sm-4  col-sm-offset-4 layout-box">
                        ...
                        <div class="row">
                            <?php if(isset($at_student_image)){
                                $at_image=$at_student_image->photo;
                            }else{
                            ...
                            <label for="favicon_icon"><?php echo $this->lang->line('favicon_icon'); ?> <span style="font-size:14px;"> Attendance Image</span></label>
...
<link href="<?php echo VENDOR_URL; ?>datepicker/datepicker.css" rel="stylesheet">
 ...
 <script type="text/javascript">
  ...
  $('#imageUpload').on('submit',function(e){
      ...
      $.ajax({
          type   : "POST",
          url    : "<?php echo site_url('attendance/student/picUpload'); ?>",
          data   : formdata,
          async  : false,
          processData: false,
          contentType: false,

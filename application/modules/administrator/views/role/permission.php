                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">                 
                        ...
                        <li class="li-class-list">
                            <select  class="form-control col-md-7 col-xs-12 gsms-nice-select_" id="filter_class_id" name="class_id"  style="width:auto;" onchange="get_permission_setting_by_role(this.value)">
                                <option value="<?php echo site_url('administrator/permission/index'); ?>" >--<?php echo $this->lang->line('select'); ?>--</option> 
                        ...
                        <div class="tab-pane pade active" id="tab_perimission"> 
                            ...
                            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        <th><?php echo $this->lang->line('sl_no'); ?></th>           
                                        <th colspan="2" class="role-text" width="25%"><?php echo $this->lang->line('module_name'); ?></th>                                        
                            ...
                            <div class="form-group">
                                <div class="col-md-6">
                                    ...
                                    <a  href="<?php echo site_url('administrator/permission/index'); ?>" class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>

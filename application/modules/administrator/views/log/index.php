<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content"> 
                <?php echo form_open_multipart(site_url('administrator/activitylog/index'), array('name' => 'activitylog', 'id' => 'activitylog', 'class' => 'form-horizontal form-label-left'), ''); ?>
                <div class="row">
                  
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="item form-group"> 
                            <div><?php echo $this->lang->line('user_type'); ?> </div>
                            <select  class="form-control col-md-7 col-xs-12 gsms-nice-select_"  name="role_id"  id="role_id" onchange="get_user_by_role(this.value, '', '');">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12 display" style="display:<?php if(isset($class_id)){ echo 'block';} ?>">
                        <div class="item form-group"> 
                            ...
                            <select  class="form-control col-md-7 col-xs-12 gsms-nice-select_"  name="class_id"  id="class_id"  onchange="get_user('', this.value,'');">
                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>  
             ...
             <div class="x_content">
                <div class="" data-example-id="togglable-tabs">                    
                    <ul  class="nav nav-tabs bordered">                 
                        <li  class="active"><a href="#tab_activitylog_list" role="tab" data-toggle="tab" aria-expanded="false"><i class="fa fa-users"></i> <?php echo $this->lang->line('activity_log'); ?></a></li>                          
                    </ul>
                    <br/>
                            ...
                            <?php if(has_permission(DELETE, 'administrator', 'activitylog')){ ?> 
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <button id="send" type="submit" class="btn btn-success" ><?php echo $this->lang->line('delete_all'); ?></button>
                                    </div>
                                </div>
                            <?php } ?>
                            <?php echo form_close(); ?>    

                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('leave/approve/update/'.$application->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                    ...
                                    <div class="item form-group">  
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select  class="form-control col-md-12 col-xs-12 gsms-nice-select_"  name="type_id"  id="type_id" required="required" onchange="get_type(this.value)">
                                    ...
                                    <div class="form-group"> 
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input  class="form-control col-md-7 col-xs-12" name="leave_date"  id="leave_date" value="<?php echo isset($application->leave_date) ?  date($this->gsms_setting->sms_date_format, strtotime($application->leave_date)) : ''; ?>" placeholder=" <?php echo $this->lang->line('date'); ?>" required="required" type="text" autocomplete="off">
                                    ...
                                    <div class="form-group"> 
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input  class="form-control col-md-7 col-xs-12" name="leave_from"  id="leave_from" value="<?php echo isset($application->leave_from) ?  date($this->gsms_setting->sms_date_format, strtotime($application->leave_from)) : ''; ?>" placeholder="<?php echo $this->lang->line('leave_from'); ?>" required="required" type="text" autocomplete="off">
                                    ...
                                    <div class="form-group"> 
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input  class="form-control col-md-7 col-xs-12" name="leave_to"  id="leave_to" value="<?php echo isset($application->leave_to) ?  date($this->gsms_setting->sms_date_format, strtotime($application->leave_to)) : ''; ?>" placeholder="<?php echo $this->lang->line('leave_to'); ?>" required="required" type="text" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="leave_note"><?php echo $this->lang->line('note'); ?> </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <textarea  class="form-control" name="leave_note" id="leave_note" placeholder="<?php echo $this->lang->line('note'); ?>"><?php echo isset($application->leave_note) ?  $application->leave_note : ''; ?></textarea>

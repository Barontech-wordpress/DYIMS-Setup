...
class Type extends MY_Controller {
    ...
    * ********************************************************** */
    private function _prepare_type_validation() {
        ...
        $this->form_validation->set_rules('total_leave', $this->lang->line('total_leave'), 'trim|required');
        $this->form_validation->set_rules('type', $this->lang->line('leave_type'), 'trim|required|callback_type');
    }

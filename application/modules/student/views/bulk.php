                                         ...
                                         <div class="item form-group">
                                             ...
                                             <select  class="form-control col-md-7 col-xs-12 gsms-nice-select_" name="academic_year_id" id="academic_year_id" required="required">
                                                ...
                                                <?php foreach($academic_years as $obj){ ?>
                                                    ...
                                                    <option value="<?php echo $obj->id; ?>" <?php echo isset($post['academic_year_id']) && $post['academic_year_id'] == $obj->id ?  'selected="selected"' : ''; ?>><?php echo $obj->session_year;  echo $running; ?></option>
                                                <?php } ?>
                                            </select>

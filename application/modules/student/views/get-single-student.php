<div class="no-print" data-example-id="togglable-tabs">
            ...
            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                <tbody>
                    <tr>
                        ...
                        <td width="30%"><?php echo $student->matric_school_name; ?></td>                       
                        <th width="20%">Previos College Name</th>
                        <td width="30%"><?php echo $student->previous_college_name; ?></td>                       
                    </tr>
                    <tr>
                        <th>Matric Total Marks</th>
                        <td><?php echo $student->matric_total_marks; ?></td>                       
                        <th>Matric Obtain Marks</th>
                        <td><?php echo $student->matric_obtain_marks; ?></td>                       
                    </tr>
                    <tr>
                        <th>Inter Total Marks</th>
                        <td><?php echo $student->inter_total_marks; ?></td>                       
                        <th>Inter Obtain Marks</th>
                        <td><?php echo $student->inter_obtain_marks; ?></td>                       
                    </tr>                    
                    <tr>
                        <th>Matric Percentage</th>
                        <td><?php echo $student->percentage_matric; ?></td>                       
                        <th>Inter Percentage</th>
                        <td><?php echo $student->percentage_inter; ?></td>                       
                    </tr>
                    <tr>
                        <th>Matric Board Name</th>
                        <td><?php echo $student->matric_board_name; ?></td>                       
                        <th>Inter Board Name</th>
                        <td><?php echo $student->inter_board_name; ?></td>                       
                    </tr>  
                      <tr> 
                         <th>Matric Result <?php echo $this->lang->line('photo'); ?></th>
                          <td>
                            <?php if ($student->matric_result_photo) { ?>
                                <img src="<?php echo UPLOAD_PATH; ?>/domicile-photo/<?php echo $student->matric_result_photo; ?>" alt="" width="70" />
                            <?php } ?>
                        </td>
                        ...
                        <td>
                            <?php if ($student->photo) { ?>
                                <img src="<?php echo UPLOAD_PATH; ?>/domicile-photo/<?php echo $student->inter_result_photo; ?>" alt="" width="70" />
                            <?php } ?>
                        </td>
                    </tr>
                </tbody>

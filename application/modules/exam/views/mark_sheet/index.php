                ...
                <div class="row">                    
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-12">
                        <div class="item form-group"> 
                            ...
                            <select  class="form-control col-md-7 col-xs-12 gsms-nice-select_" name="academic_year_id" id="academic_year_id" required="required" onchange="get_exam_by_academic_year(this.value)">

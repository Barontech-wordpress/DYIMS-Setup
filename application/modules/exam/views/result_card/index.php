    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
                ...
                <div class="row no-print">  
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-12">
                        <div class="item form-group"> 
                            ...
                            <select  class="form-control col-md-7 col-xs-12 gsms-nice-select_" name="section_id" id="section_id" required="required" onchange="get_student_by_section(this.value,'');">                                
                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                            </select>
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="item form-group"> 
                            ...
                            <select  class="form-control col-md-7 col-xs-12 gsms-nice-select" name="student_id" id="student_id" required="required">                                
                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                            </select>
            ...
            <div class="x_content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h4><strong><?php echo $this->lang->line('exam_term_result'); ?></strong></h4>
                    </div>
                </div>
                <table id="datatable-responsive" class="table table-striped_ table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    <thead>
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo isset($exam->name) ? $exam->name : ''; ?></td>
                ...
                <thead>
                 ...
                 <tbody>
                    ...
                    <?php $section_position = get_position_student_position($academic_year_id, $class_id,$student_id, $section_id); ?> 
                     <tr>
                         <td><?php echo isset($final_result->total_subject) ? $final_result->total_subject : ''; ?></td> 
                         ...
                         <td><?php echo isset($final_result->grade) ? $final_result->grade : ''; ?></td> 
                         <td><?php echo $this->lang->line(isset($final_result->result_status) ? $final_result->result_status : ''); ?></td> 

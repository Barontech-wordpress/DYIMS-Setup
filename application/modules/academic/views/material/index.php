                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <?php } ?>                
                            ...
                            <li class="li-class-list">
                                ...
                                <select  class="form-control col-md-7 col-xs-12 gsms-nice-select_" onchange="get_material_list_by_class(this.value);">
                        ...
                        <div class="tab-pane fade in active" id="tab_edit_material">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('academic/material/edit/'.$material->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-12 col-xs-12 gsms-nice-select_"  name="status"  id="status" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                                                                    
                                            <option value="1" <?php if($material->status == 1){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('active'); ?></option>                                           
                                            <option value="0" <?php if($material->status == 0){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('in_active'); ?></option>                                                                                       
                                        </select>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        <input type="hidden" value="<?php echo isset($material) ? $material->id : ''; ?>" name="id" />
                                        <a href="<?php echo site_url('academic/material/index'); ?>" class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>

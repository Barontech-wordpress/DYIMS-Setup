<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-info-circle"></i><small> <?php echo $this->lang->line('manage_award'); ?></small></h3>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_award">
                            <div class="x_content"> 
                               <?php echo form_open(site_url('miscellaneous/award/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="form-group"> 
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="price"><?php echo $this->lang->line('price'); ?> (<?php echo $this->gsms_setting->currency_symbol; ?>)<span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="x_content"> 
                               <?php echo form_open(site_url('miscellaneous/award/edit/'.$award->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                    ...
                                    <div class="form-group"> 
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input  class="form-control col-md-7 col-xs-12"  name="note"  id="edit_note" value="<?php echo isset($award->note) ?  $award->note : ''; ?>" placeholder="<?php echo $this->lang->line('note'); ?>" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('note'); ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-md-offset-3">
                                            <input type="hidden" value="<?php echo isset($award) ? $award->id : $id; ?>" id="id" name="id" />
                                            <a  href="<?php echo site_url('miscellaneous/award/index'); ?>" class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>
...
<link href="<?php echo VENDOR_URL; ?>datepicker/datepicker.css" rel="stylesheet">
 ...
 <script type="text/javascript">
   ...
   <?php } ?>
    ...
    <?php if(isset($award)){ ?> 
          get_user('', '<?php echo $award->class_id; ?>', '<?php echo $award->user_id; ?>');
    <?php } ?>

<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-money"></i><small> <?php echo $this->lang->line('manage_issue_and_return'); ?></small></h3>
                            ...
                            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo $this->lang->line('issue_to_user'); ?></th>
                                ...
                                <tbody>   
                                    ...
                                    <?php $count = 1; if(isset($issues) && !empty($issues)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo date($this->gsms_setting->sms_date_format, strtotime($obj->check_in_date)); ?></td>
                                            <td>
                                                <?php 
                                                    if($obj->check_out_date){
                                                        echo date($this->gsms_setting->sms_date_format, strtotime($obj->check_out_date));
                                                    }else{ 
                                                      if(has_permission(EDIT, 'asset', 'issue')){         
                                                        echo '<a style="color:red;" href="javascript:void(0);" onclick="issue_check_out('.$obj->id.');">'.$this->lang->line('return_this').'</a>';
                                                      }
                                                    }
                                                   ?>
                                            </td>                                           
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_issue">
                            <div class="x_content"> 
                               <?php echo form_open(site_url('asset/issue/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">  
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="user_id"><?php echo $this->lang->line('issue_to_user'); ?> <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12 gsms-nice-select"  name="category_id"  id="add_category_id" required="required" onchange="get_item_by_category(this.value, '', 'add');" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-12 col-xs-12 gsms-nice-select"  name="item_id"  id="add_item_id" required="required" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                                                                         
                                        </select>
                            ...
                            <div class="x_content"> 
                               <?php echo form_open(site_url('asset/issue/edit/'.$issue->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="category_id"><?php echo $this->lang->line('category'); ?> <span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12 gsms-nice-select"  name="category_id"  id="edit_category_id" required="required" onchange="get_item_by_category(this.value, '', 'edit');" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                            <?php if(isset($catagories) && !empty($catagories)){ ?>
                                                <?php foreach($catagories as $obj){ ?>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-12 col-xs-12 gsms-nice-select"  name="item_id"  id="edit_item_id" required="required" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                                                                         
                                        </select>
                                        <div class="help-block"><?php echo form_error('item_id'); ?></div>
                                        </div>
                                    ...
                                    <div class="form-group"> 
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="note"> <?php echo $this->lang->line('note'); ?></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input  class="form-control col-md-7 col-xs-12"  name="note"  id="edit_note" value="<?php echo isset($issue->note) ?  $issue->note : ''; ?>" placeholder="<?php echo $this->lang->line('note'); ?>" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('note'); ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-md-offset-3">
                                            ...
                                            <input type="hidden" value="<?php echo isset($issue) ? $issue->id : $id; ?>" id="id" name="id" />
                                            <a  href="<?php echo site_url('asset/issue/index'); ?>" class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>

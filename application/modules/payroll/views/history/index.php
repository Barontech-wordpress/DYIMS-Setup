                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="item form-group"> 
                            <div><?php echo $this->lang->line('role'); ?> <span class="required"> *</span></div>
                            <select  class="form-control col-md-7 col-xs-12 gsms-nice-select_"  name="payment_to"  id="payment_to" onchange="get_user_list(this.value);" required="required">

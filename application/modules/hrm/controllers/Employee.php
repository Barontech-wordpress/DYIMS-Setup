...
class Employee extends MY_Controller {
    ...
    function __construct() {
        ...
        $this->data['departments'] = $this->employee->get_list('emp_departments', array('status' => 1), '', '', '', 'id', 'ASC');
    ...
    * ********************************************************** */
    private function _prepare_employee_validation() {
        ...
        $this->form_validation->set_rules('salary_grade_id', $this->lang->line('salary_grade'), 'trim');
        $this->form_validation->set_rules('salary_type', $this->lang->line('salary_type'), 'trim');
    ...
    * ********************************************************** */ 
    private function _get_posted_employee_data() {
        ...
        $data['resign_date'] = $this->input->post('resign_date') ? date('Y-m-d', strtotime($this->input->post('resign_date'))) : '';
        ...
        if ($this->input->post('id')) {
            ...
            $data['display_order'] = $this->employee->count_all('employees', array('status'=>1))+1;
        }

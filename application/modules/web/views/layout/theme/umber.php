<style type="text/css">
    ...
    .single-teacher .social li a,
    .gallery-menu .button {
        border: 1px solid #745D0B;
    }
    .header-bottom {
        border-bottom: 1px solid #745D0B;
    }
    ...
    .section-title .title {
        border-bottom: 3px solid #745D0B;
    }
    
    footer {
     border-top: 3px solid #745D0B;
    }


    .single-achivement {
        border: 4px solid #745D0B;
    }

    .single-achivement .icon {
        border-bottom: 2px solid #745D0B;
        color:  #745D0B;    
    }


    .single-facilities::before {
        background-image: url(<?php echo IMG_URL; ?>front/icon/round-umber.png);
    }
    ...
    .single-news::before {
        background-image: url(<?php echo IMG_URL; ?>front/icon/border-1-umber.png);
    }
    ...
    .single-notice::after,
    .single-news::after {
        background-image: url(<?php echo IMG_URL; ?>front/icon/border-2-umber.png);
    }
    ...
    .welcome-banner::after {
        background-color: #bd9814;
    }

    .single-hero-carousel .box {
        background: rgb(92 106 48 / 50%);   
    }

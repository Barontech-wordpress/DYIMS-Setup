...
class Type extends MY_Controller {
    ...
    function __construct() {
        ...
        $this->data['certificates'] = $this->type->get_list('certificates', array(), '','', '', 'id', 'ASC'); 
    ...
    * ********************************************************** */
    private function _prepare_type_validation() {
        ...
        $this->form_validation->set_rules('name', $this->lang->line('certificate_name'), 'trim|required|callback_name');
        $this->form_validation->set_rules('top_title', $this->lang->line('school_name'), 'trim|required');

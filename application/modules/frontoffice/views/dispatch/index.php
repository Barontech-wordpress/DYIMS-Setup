                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('frontoffice/dispatch/edit/'.$dispatch->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="dispatch_date"> <?php echo $this->lang->line('dispatch_date'); ?> <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="dispatch_date"  id="edit_dispatch_date" value="<?php echo isset($dispatch) ?  date($this->gsms_setting->sms_date_format, strtotime($dispatch->dispatch_date)) : ''; ?>" placeholder="<?php echo $this->lang->line('dispatch_date'); ?>" required="required" type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('dispatch_date'); ?></div>
                                    </div>
                                </div>                                  
                                ...
                                <div class="item form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-12 col-xs-12 gsms-nice-select_"  name="status"  id="status" >
                                            ...
                                            <option value="1" <?php if($dispatch->status == 1){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('active'); ?></option>                                           
                                            <option value="0" <?php if($dispatch->status == 0){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('in_active'); ?></option>                                                                                       
                                        </select>

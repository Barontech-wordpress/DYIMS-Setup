...
class Payment extends MY_Controller {
    ...
    * @type            : Function
    * @function name   : dbbl
    * @description     : Load "dbbl Setting Tab" user interface                 
    *                     and process to save dbbl setting inormation into database  
    * @param           : null
    * @return          : null 
    * ********************************************************** */
    ...
    * @type            : Function
    * @function name   : _prepare_dbbl_validation
    ...
    * ********************************************************** */
    private function _prepare_dbbl_validation() {
        ...
        $this->form_validation->set_rules('dbbl_demo', $this->lang->line('is_demo'), 'trim|required');
        $this->form_validation->set_rules('dbbl_status', $this->lang->line('is_active'), 'trim|required');
    }

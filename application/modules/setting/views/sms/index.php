                        ...
                        <div class="tab-pane fade in <?php echo isset($clickatell) ? 'active':''; ?>" id="tab_clickatell_setting">
                            <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12 gsms-nice-select"  name="clickatell_status" required="required">
                          ...
                          <div class="tab-pane fade in <?php echo isset($twilio) ? 'active':''; ?>" id="tab_twilio_setting">
                             <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12 gsms-nice-select"  name="twilio_status" required="required">
                        ...
                        <div class="tab-pane fade in <?php echo isset($bulk) ? 'active':''; ?>" id="tab_bulk_setting">
                            <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12 gsms-nice-select"  name="bulk_status">
                        ...
                        <div class="tab-pane fade in <?php echo isset($msg91) ? 'active':''; ?>" id="tab_msg91_setting">
                            <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12 gsms-nice-select"  name="msg91_status" required="required">
                        ...
                        <div class="tab-pane fade in <?php echo isset($plivo) ? 'active':''; ?>" id="tab_plivo_setting">
                            <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12 gsms-nice-select"  name="plivo_status" required="required">
                        ...
                        <div class="tab-pane fade in <?php echo isset($textlocal) ? 'active':''; ?>" id="tab_textlocal_setting">
                            <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12 gsms-nice-select"  name="textlocal_status" required="required">
                        ...
                        <div class="tab-pane fade in <?php echo isset($smscountry) ? 'active':''; ?>" id="tab_smscountry_setting">
                            <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12 gsms-nice-select"  name="smscountry_status" required="required">
                        ...
                        <div class="tab-pane fade in <?php echo isset($betasms) ? 'active':''; ?>" id="tab_betasms_setting">
                            <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12 gsms-nice-select"  name="betasms_status" required="required">
                        ...
                        <div class="tab-pane fade in <?php echo isset($bulkpk) ? 'active':''; ?>" id="tab_bulkpk_setting">
                            <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12 gsms-nice-select"  name="bulk_pk_status" required="required">
                        ...
                        <div class="tab-pane fade in <?php echo isset($cluster) ? 'active':''; ?>" id="tab_cluster_setting">
                            <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12 gsms-nice-select"  name="cluster_status" required="required">
                      ...
                      <div class="tab-pane fade in <?php echo isset($alpha) ? 'active':''; ?>" id="tab_alpha_setting">
                            <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12 gsms-nice-select"  name="alpha_type" required="required">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12 gsms-nice-select"  name="alpha_status" required="required">
                         ...
                         <div class="tab-pane fade in <?php echo isset($bdbulk) ? 'active':''; ?>" id="tab_bdbulk_setting">
                            <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12 gsms-nice-select"  name="bdbulk_type" required="required">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12 gsms-nice-select"  name="bdbulk_status" required="required">
                        ...
                        <div class="tab-pane fade in <?php echo isset($mimsms) ? 'active':''; ?>" id="tab_mimsms_setting">
                            <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12 gsms-nice-select"  name="mim_type" required="required">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12 gsms-nice-select"  name="mim_status" required="required">

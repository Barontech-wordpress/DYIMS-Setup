                     ...
                     <div class="tab-content">
                         <div class="tab-pane fade in active"id="tab_setting">
                            <div class="x_content"> 
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="school_name"  id="school_name" value="<?php echo isset($setting) ? $setting->school_name : ''; ?>" placeholder="<?php echo $this->lang->line('school_name'); ?>" required="required" type="text" autocomplete="off">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="phone"  id="phone" value="<?php echo isset($setting) ? $setting->phone : ''; ?>" placeholder="<?php echo $this->lang->line('phone'); ?> " required="required" type="number" autocomplete="off">
                                ...
                                <div class="row">                                    
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="registration_date"  id="registration_date" value="<?php echo isset($setting) ? date($this->gsms_setting->sms_date_format, strtotime($setting->registration_date)) : ''; ?>" placeholder="<?php echo $this->lang->line('registration_date'); ?> " required="required" type="text" autocomplete="off">
                                ...
                                <div class="row">                                    
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <select  class="form-control col-md-7 col-xs-12 gsms-nice-select_"  name="enable_frontend" required="required">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <select  class="form-control col-md-7 col-xs-12 gsms-nice-select_"  name="enable_online_admission" id="enable_online_admission" required="required">
                                ...
                                <div class="row">                                    
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <select  class="form-control col-md-7 col-xs-12 gsms-nice-select_"  name="final_result_type" required="required">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="language"><?php echo $this->lang->line('language'); ?> <span class="required">*</span></label>
                                             <select  class="form-control col-md-7 col-xs-12 gsms-nice-select_"  name="language"  required="required">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <select  class="form-control col-md-7 col-xs-12 gsms-nice-select_"  name="enable_rtl" required="required">
                                ...
                                <div class="row">                                    
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <select  class="form-control col-md-7 col-xs-12 gsms-nice-select_"  name="academic_year_id" >
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <?php foreach($years as $obj){ ?>
                                                    <?php $running = $obj->is_running ? ' ['.$this->lang->line('running_year').']' : ''; ?>
                                                    <option value="<?php echo $obj->id; ?>" <?php if(isset($setting) && $setting->academic_year_id == $obj->id){ echo 'selected="selected"';} ?>><?php echo $obj->session_year;  echo $running; ?></option>
                                                <?php } ?>
                                            </select>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                           ...
                                           <?php $timezones = get_timezones(); ?>
                                            <select  class="form-control col-md-7 col-xs-12 gsms-nice-select"  name="default_time_zone" required="required">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="sms_date_format"><?php echo $this->lang->line('date_format'); ?> <span class="required">*</span></label>
                                              ...
                                              <select  class="form-control col-md-7 col-xs-12 gsms-nice-select_"  name="sms_date_format" required="required">
                                                  <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="google_analytics"><?php echo $this->lang->line('google_analytics'); ?></label>
                                ...
                                <!--        <div class="item form-group">-->
                                <!--            <label for="google_map"><?php echo $this->lang->line('google_map_embed'); ?> </label>-->
                                <!--            <textarea style="height: 60px" class="form-control col-md-7 col-xs-12"  name="google_map"  id="google_map"  placeholder="<?php echo $this->lang->line('google_map_embed'); ?> " ><?php echo isset($setting) ? $setting->google_map : ''; ?></textarea>-->
                                ...
                                <!--<div class="row">                  -->
                                <!--    <div class="col-md-12 col-sm-12 col-xs-12">-->
                                <!--        <h5  class="column-title"><strong><?php echo $this->lang->line('live_class'); ?>:</strong></h5>-->
                                <!--    </div>-->
                                <!--</div>-->
                                <!--<div class="row"> -->
                                <!--    <div class="col-md-3 col-sm-3 col-xs-12">-->
                                ...
                                <!--                <input  class="form-control col-md-7 col-xs-12"  name="zoom_api_key"  id="zoom_api_key" value="<?php echo isset($setting) ? $setting->zoom_api_key : ''; ?>" placeholder="<?php echo $this->lang->line('zoom_api_key'); ?> "  type="text" autocomplete="off">-->
                                ...
                                <!--                <input  class="form-control col-md-7 col-xs-12"  name="zoom_secret"  id="zoom_secret" value="<?php echo isset($setting) ? $setting->zoom_secret : ''; ?>" placeholder="<?php echo $this->lang->line('zoom_secret'); ?> "  type="text" autocomplete="off">-->
                               ...
                               <div class="row">                             
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="brand_logo"><?php echo $this->lang->line('brand_logo'); ?> <span style="font-size:10px;"> [Max W: 70px, Max H: 70px]</span></label>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="logo"><?php echo $this->lang->line('admin_logo'); ?> <span style="font-size:10px;"> [Max W: 160px, Max H: 80px]</span></label>
                                            <div class="btn btn-default btn-file"><i class="fa fa-paperclip"></i> <?php echo $this->lang->line('upload'); ?>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="front_logo"><?php echo $this->lang->line('frontend_logo'); ?> <span style="font-size:10px;"> [Max W: 160px, Max H: 80px]</span></label>
                                            <div class="btn btn-default btn-file"><i class="fa fa-paperclip"></i> <?php echo $this->lang->line('upload'); ?>

...
class Frontend extends MY_Controller {
    ...
    * ********************************************************** */
     ...
     * @return          : null 
     * ********************************************************** */
    public function get_single_page(){
        
       $page_id = $this->input->post('page_id');
       
       $this->data['frontend'] = $this->frontend->get_single('pages', array('id' => $page_id));
       echo $this->load->view('get-single-page', $this->data);
    }
    ...
    * ********************************************************** */
    private function _prepare_frontend_validation() {
        ...
        $this->form_validation->set_rules('page_location', $this->lang->line('location'), 'trim|required');
        $this->form_validation->set_rules('page_title', $this->lang->line('title') . 'trim|required|callback_page_title');
        $this->form_validation->set_rules('page_image', $this->lang->line('image'), 'trim|callback_page_image');
        $this->form_validation->set_rules('page_description', $this->lang->line('description'), 'trim|required');
    }

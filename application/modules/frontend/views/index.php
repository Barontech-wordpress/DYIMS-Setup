                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <li class="<?php if(isset($list)){ echo 'active'; }?>"><a href="#tab_page_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i>  <?php echo $this->lang->line('list'); ?></a> </li>
                        <?php if(has_permission(ADD, 'frontend', 'frontend')){ ?>
                          ...
                          <?php if(isset($edit)){ ?>
                                <li  class="<?php if(isset($add)){ echo 'active'; }?>"><a href="<?php echo site_url('frontend/add'); ?>"  role="tab"  aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('create'); ?> </a> </li>                          
                          <?php }else{ ?>
                                <li  class="<?php if(isset($add)){ echo 'active'; }?>"><a href="#tab_add_page"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('create'); ?></a> </li>                          
                          <?php } ?>   
                               ...
                               <?php echo form_open_multipart(site_url('frontend/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <select  class="form-control col-md-7 col-xs-12  gsms-nice-select" name="page_location" id="page_location" required="required">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="page_title"  id="page_title" value="<?php echo isset($post['page_title']) ?  $post['page_title'] : ''; ?>" placeholder=" <?php echo $this->lang->line('title'); ?>" required="required" type="text">
                                        <div class="help-block"><?php echo form_error('page_title'); ?></div>
                                    </div>
                                </div>
                                
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="page_slug"><?php echo $this->lang->line('page'); ?>/<?php echo $this->lang->line('url_slug'); ?> <span class="required">*</span> </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="page_slug"  id="page_slug" value="<?php echo isset($post['page_slug']) ?  $post['page_slug'] : ''; ?>" placeholder="" required="required" type="text" autocomplete="off">
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('frontend/edit/'.$page->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <select  class="form-control col-md-7 col-xs-12  gsms-nice-select" name="page_location" id="page_location" required="required">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                                                                    
                                            <?php foreach($locations as $key=>$value){ ?>                                           
                                            <option value="<?php echo $key; ?>" <?php if(isset($page->page_location) &&  $page->page_location == $key){ echo 'selected="selected"';} ?>><?php echo $value; ?></option>
                                            <?php } ?>           
                                        </select>
                                        <div class="help-block"><?php echo form_error('page_location'); ?></div>
                                    </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="page_title"  id="page_title" value="<?php echo isset($page->page_title) ?  $page->page_title : ''; ?>" placeholder=" <?php echo $this->lang->line('title'); ?>" required="required" type="text">
                                        <div class="help-block"><?php echo form_error('page_title'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="page_slug"><?php echo $this->lang->line('page'); ?> /<?php echo $this->lang->line('url_slug'); ?> <span class="required">*</span> </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="page_slug"  id="page_slug" value="<?php echo isset($page->page_slug) ?  $page->page_slug : ''; ?>" placeholder="" required="required" type="text" autocomplete="off">
                                        <div class="text-info">Ex: terms-and-condition. [ Must be english text ]</div>
                                        <div class="help-block"><?php echo form_error('page_slug'); ?></div>
                                    </div>
                                </div>

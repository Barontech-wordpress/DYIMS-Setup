            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                       ...
                       <div class="row">
                           <div class="col-sm-6 col-xs-6  col-sm-offset-3 col-xs-offset-3 layout-box">
                               <p>
                                   ...
                                   <h3 class="head-title ptint-title"><i class="fa fa-bar-chart"></i><small> <?php echo $this->lang->line('invoice_report'); ?></small></h3>                
                               </p>
                           </div>
                       </div>            
                   </div>
                    ...
                    <ul  class="nav nav-tabs bordered no-print">
                        ...
                        <li  class="active"><a href="#tab_graphical"   role="tab" data-toggle="tab"  aria-expanded="false"><i class="fa fa-line-chart"></i> <?php echo $this->lang->line('tabular_report'); ?></a> </li>                          
                    </ul>
                    <br/>

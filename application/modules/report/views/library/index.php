                    ...
                    <div class="x_content">             
                       <div class="row">
                           <div class="col-sm-6 col-xs-6  col-sm-offset-3 col-xs-offset-3 layout-box">
                                   ...
                                   <h3 class="head-title ptint-title"><i class="fa fa-bar-chart"></i><small> <?php echo $this->lang->line('library_report'); ?></small></h3>                
                            ...
                            <table id="datatable-keytable" class="datatable-responsive table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo $this->lang->line('issue_total'); ?></th>
                                        <th><?php echo $this->lang->line('return_total'); ?></th>
                                        <th><?php echo $this->lang->line('remain_total'); ?></th>
                                    </tr>
                                </thead>
                                <tbody>   
                                    <?php 
                                 ...
                                 <script type="text/javascript">
                                    ...
                                    $(function () {
                                        $('#library-report').highcharts({
                                            ...
                                            title: {
                                                text: '<?php echo $this->lang->line('issue_and_return'); ?>'
                                            },
                                            xAxis: {
                                                categories: [
                                                   <?php foreach($library as $obj){ ?> 

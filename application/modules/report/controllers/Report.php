...
class Report extends My_Controller {
    ...
    * ********************************************************** */
    public function balance() {
        ...
        $this->layout->title($this->lang->line('blance_report') . ' | ' . SMS);
    ...
    * ********************************************************** */
    public function statement() {
        ...
        $this->layout->title($this->lang->line('statement_report') . ' | ' . SMS);
    ...
    * ********************************************************** */
    public function transaction() {
        ...
        $this->layout->title($this->lang->line('transaction_report') . ' | ' . SMS);
    ...
    * ********************************************************** */
    public function sactivity() {
        ...
        $this->data['classes'] = $this->report->get_list('classes', array('status' => 1), '', '', '', 'id', 'ASC');
        $this->layout->title($this->lang->line('activity_report') . ' | ' . SMS);
    ...
    * ********************************************************** */
    public function duefee() {
        ...
        $this->data['classes'] = $this->report->get_list('classes', array('status' => 1), '', '', '', 'id', 'ASC');
        $this->layout->title($this->lang->line('due_fee_invoice_report') .' | ' . SMS);
    ...
    * ********************************************************** */
    public function bulkduefee() {
        ...
        if ($_POST) {
            ...
            $this->data['academic_year_id'] = $academic_year_id ? $academic_year_id : $this->academic_year_id;
            $this->data['student_id'] = $student_id;            
            $this->data['class_id'] = $class_id;     
            
            $this->data['students'] = $this->report->get_due_fee_student_list($academic_year_id, $class_id, $student_id);  
            $this->data['class'] = $this->report->get_single('classes', array('id' => $class_id));            
        }
        
        $this->data['classes'] = $this->report->get_list('classes', array('status' => 1), '', '', '', 'id', 'ASC');
        $this->layout->title($this->lang->line('bulk_due_fee_report') . ' | ' . SMS);
        $this->layout->view('invoice/bulk_due_fee', $this->data);
    ...
    * ********************************************************** */
    public function feecollection() {
        ...
        if ($_POST) {
            ...
            $this->data['feecollection'] = $this->report->get_student_fee_collection_report($academic_year_id, $class_id, $student_id, $date_from, $date_to);
        }

...
class Report_Model extends MY_Model {
    ...
    public function get_credit_by_date($date){
        ...
        $this->db->select('T.amount as credit, T.payment_date, T.note');
    ...
    public function get_student_fee_collection_report($academic_year_id, $class_id, $student_id, $date_from, $date_to){
    ...
    public function get_due_fee_student_list($academic_year_id = null, $class_id = null, $student_id = null){
         
        
        $this->db->select('E.roll_no, S.father_name, S.id, S.name, G.name as guardian_name, C.name as class_name');
        $this->db->from('enrollments AS E');        
        $this->db->join('students AS S', 'S.id = E.student_id', 'left');
        $this->db->join('guardians AS G', 'G.id = S.guardian_id', 'left');
        $this->db->join('classes AS C', 'C.id = E.class_id', 'left');

                            ...
                            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th> <?php echo $this->lang->line('gallery'); ?></th>
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('gallery/image/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="gallery_id"> <?php echo $this->lang->line('gallery'); ?> <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12 gsms-nice-select_"  name="gallery_id"  id="gallery_id" required="required">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                            <?php foreach($galleries as $obj){ ?>
                                             <option value="<?php echo $obj->id; ?>" <?php echo isset($post['gallery_id']) ?  'selected="selected"' : ''; ?>><?php echo $obj->title; ?></option> 
                                            <?php } ?>                                                                              
                                        </select>
                               ...
                               <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="caption"  id="caption" value="<?php echo isset($post['caption']) ?  $post['caption'] : ''; ?>" placeholder="<?php echo $this->lang->line('caption'); ?>" type="text">
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('gallery/image/edit/'.$image->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12 gsms-nice-select_"  name="gallery_id"  id="gallery_id" required="required">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                            <?php foreach($galleries as $obj){ ?>
                                             <option value="<?php echo $obj->id; ?>" <?php echo ($obj->id == $image->gallery_id) ?  'selected="selected"' : ''; ?>><?php echo $obj->title; ?></option> 
                                            <?php } ?>                                                                              
                                        </select>
                                        <div class="help-block"><?php echo form_error('gallery_id'); ?></div>
                                    </div>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="caption"><?php echo $this->lang->line('caption'); ?> </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="caption"  id="caption" value="<?php echo isset($image->caption) ?  $image->caption : ''; ?>" placeholder="<?php echo $this->lang->line('caption'); ?>" type="text">
                                        <div class="help-block"><?php echo form_error('caption'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-12 col-xs-12 gsms-nice-select_"  name="status"  id="status" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                                                                    
                                            <option value="1" <?php if($image->status == 1){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('active'); ?></option>                                           
                                            <option value="0" <?php if($image->status == 0){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('in_active'); ?></option>                                                                                       
                                        </select>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        <input type="hidden" value="<?php echo isset($image) ? $image->id : ''; ?>" name="id" />
                                        <a href="<?php echo site_url('gallery/image/index'); ?>" class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>

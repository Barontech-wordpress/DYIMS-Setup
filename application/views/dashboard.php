...
<div class="row tile_count">
    ...
    <?php if(has_permission(VIEW, 'accounting', 'income')){ ?>
        <div class="col-md-2 col-sm-4 col-xs-12 tile_stats_count">
            <div class="stats-count-inner">
                <span class="count_top"><strong class="green"><?php echo $this->gsms_setting->currency_symbol; ?></strong> <?php echo $this->lang->line('income'); ?></span>
    ...
    <div class="col-md-2 col-sm-4 col-xs-12 tile_stats_count">
        <div class="stats-count-inner">
            <span class="count_top"> <strong class="red"><?php echo $this->gsms_setting->currency_symbol; ?></strong> <?php echo $this->lang->line('expenditure'); ?></span>
                                    ...
                                    series: [{
                                            ...
                                            data: [
                                                <?php if(isset($students) && !empty($students)){ ?>
                                                    ...
                                                    ['<?php echo $obj->class_name; ?>', <?php echo $obj->total_student; ?>],
                                                    <?php } ?>
                                                <?php } ?>                                                
                                            ]
                                        }],

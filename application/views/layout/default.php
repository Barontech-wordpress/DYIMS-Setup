    ...
    <body class="nav-md">
        ...
        <div class="container body">
            <div class="main_container">
                ...
                <div class="<?php echo $this->gsms_setting->enable_rtl ? 'left_col' : 'right_col'; ?>  body-layout" role="main" style="min-height: 1400px;">                  
       ...
       <!-- dataTable with buttons end -->
        ...
        <script type="text/javascript" src="<?php echo VENDOR_URL; ?>select2/select2.min.js"></script>

                               ...
                               <?php echo form_open_multipart(site_url('usercomplain/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12 gsms-nice-select_"  name="type_id"  id="type_id" required="required">
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        <a href="<?php echo site_url('usercomplain/index'); ?>" class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>

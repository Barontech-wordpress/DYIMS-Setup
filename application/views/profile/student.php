            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <div class="tab-content">                  
                        ...
                        <div  class="tab-pane fade in <?php if(isset($info)){ echo 'active'; }?>" id="tab_profile">
                            <div class="x_content">  
                                ...
                                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                    <tbody>
                                        <tr>
                                            <th width="18%"><?php echo $this->lang->line('student_name'); ?></th>
                                            <td width="32%"><?php echo $profile->name; ?></td>
                                            <th width="18%"><?php echo $this->lang->line('student_type'); ?></th>
                                ...
                                <div class="row"> 
                                     ...
                                     <div class="col-md-6 col-sm-6 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <textarea  class="form-control col-md-7 col-xs-12 textarea-4column"  name="permanent_address"  id="add_permanent_address"  placeholder="<?php echo $this->lang->line('permanent_address'); ?>"><?php echo isset($profile->permanent_address) ?  $profile->permanent_address : ''; ?></textarea>
                        ...
                        <div  class="tab-pane fade in " id="tab_parent_info">
                            <div class="x_content">                                 
                                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                    <tbody>                                       
                                        <tr>
                                            <th width="18%"><?php echo $this->lang->line('father_name'); ?></th>
                                            <td width="32%"><?php echo $profile->father_name; ?></td>
                                            <th width="18%"><?php echo $this->lang->line('mother_name'); ?></th>
                        ...
                        <div  class="tab-pane fade in  no-print" id="tab_payment" >
                            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                <thead>
                                    <tr>

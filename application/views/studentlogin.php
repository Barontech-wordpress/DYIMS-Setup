...
<html lang="en">
    ...
    <body class="login">     
        ...
        <div class="login_wrapper" >
            <section>
                <center>
                    ...
                    <!--<?php } ?>-->
                        <img  width="200px" height="auto" src="<?php echo site_url('assets/images/white-blue-logo.png');?>">
                </center>
            </section>
        ...
        <center>
                <div class="btn-group top-mar" role="group" aria-label="...">
                    <a href="<?php echo site_url('/login')?>"><button class="btn btn-sm btn-warning demo-button" id="superadmin">Admin</button></a>
                    <a href="<?php echo site_url('/login')?>"><button class="btn btn-sm btn-success demo-button" id="student">Student</button></a>
                    <a href="<?php echo site_url('/login')?>"><button class="btn btn-sm btn-warning demo-button" id="teacher">Teacher</button></a>
                    <a href="<?php echo site_url('/login')?>"> <button class="btn btn-sm btn-info demo-button" id="accountant">Accountant</button></a>
                    <a href="<?php echo site_url('/login')?>"><button class="btn btn-sm btn-danger demo-button" id="librarian">Librarian</button></a>
                </div>
        </center>
    </body>
</html>
